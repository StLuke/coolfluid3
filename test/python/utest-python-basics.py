...
cf_check(journal.options.RecordReplies is False,
         'RecordReplies of the journal is not false')
...
action_director = root.create_component(
    'director', 'cf3.common.ActionDirector')
action_director.options().set('disabled_actions', ['a', 'b', 'c'])

cf_check(root.derived_type_name() == 'cf3.common.Group',
         'Derived type name of Root is not equal to \'cf3.common.Group\'')
